...
const HealthForm = () => {
  ...
  const addNewMedicines = (event) => {
    event.preventDefault();

    setMedicines((prevMedicines) => [...prevMedicines, { name: "", time: "" }]);
  ...
  const addNewDisabilities = (event) => {
    event.preventDefault();
    ...
    <form onSubmit={handleSubmit((data) => setData(data))} className="form">
      ...
      <section>
        <div className="table">
          ...
          <div className="table">
            <div className="table-title">Medicines You Take</div>
            <div className="table-content">
                ...
                {Medicines.map((item, index) => (
                  <div className="table-row" key={index}>
                    <div className="table-data">
                      ...
                      />
                      <label for="time">Choose Time to take</label>
                      <select
                        name="time"
                        id="time"
                        // value={item.time}
      ...
      <section>
        ...
        <div className="wrap2">
          <div className="BankAccountTransfer">
            <label> Amount to Transfer from Your Account</label>
            <Controller
              control={control}
...
const LinearStepper = () => {
  ...
  return (
    <div>
      <Stepper alternativeLabel activeStep={activeStep} className="Upperbox">
