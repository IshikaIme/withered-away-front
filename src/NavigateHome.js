		...
		return (
			<BrowserRouter>
				<Routes>
					...
					<Route
						path="/CallAdminDash"
						element={<CallAdminDash />}
					></Route>
					<Route
						path="/CallPeopleDash"
						element={<CallPeopleDash />}
					></Route>
					<Route
						path="/CallStaffDash"
						element={<CallStaffDash />}
					></Route>
					<Route
						path="/CallDoctorDash"
						element={<CallDoctorDash />}
					></Route>
					...
					<Route
						path="/TableMedicine"
						element={<TableMedicine />}
					></Route>
					<Route
						path="/TableFoodPeople"
						element={<TableFoodPeople />}
					></Route>
					<Route
						path="/TableDonation"
						element={<TableDonation />}
					></Route>
					<Route
					...
					<Route
						path="/CallDonations"
						element={<CallDonations />}
					></Route>
					<Route
						path="/Transactions"
						element={<Transactions />}
					></Route>
					{/* <PeopleProtectedRoute
						exact
						path="/Transactions"
						element={Transactions}
					></PeopleProtectedRoute> */}
