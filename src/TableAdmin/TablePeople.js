...
function TablePeople() {
  ...
  useEffect(() => {
    fetch("https://withered-away-back-postgres.onrender.com" + "/api/people")
      .then((resp) => resp.json())
      .then((resp) => {
        ...
        editable={{
          onRowAdd: (newData) =>
            new Promise((resolve, reject) => {
              ...
              axios
                .post(
                  "https://withered-away-back-postgres.onrender.com" + "/api/people",
          ...
          onRowUpdate: (newData, oldData) =>
            new Promise((resolve, reject) => {
              ...
              axios
                .patch(
                  "https://withered-away-back-postgres.onrender.com" + `/api/people/id/${newData.ID}`,
                  newData
                )
                .then((res) => {
          ...
          onRowDelete: (oldData) =>
            new Promise((resolve, reject) => {
              ...
              let url = "https://withered-away-back-postgres.onrender.com" + `/api/people/${contactId}`;
